...
- Version 0.8.x and onwards provides a new and much more flexible implementation. Most but not all features from 0.6.x have been ported to this re-implementation.
